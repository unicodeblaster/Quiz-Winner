...
const Home = ({name, setName, fetchQuestions, clickSound}) => {
    ...
    return (
        <div className='content'>
            ...
            <img src="https://thumbs.dreamstime.com/b/black-question-mark-filled-bunch-random-small-white-marks-questionmark-banner-concept-isolated-b-background-vector-240547226.jpg" className="banner" alt="quiz img"></img>
        </div>
    )
}
